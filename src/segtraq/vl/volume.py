...
from ..utils import _ensure_index, _is_background, merge_into_obs, pearson_residuals, estimate_theta_simple
...
def compute_sim_top_bottom_z(
    ...
    X = np.vstack([counts_bottom_raw.to_numpy(),
               counts_top_raw.to_numpy()])  
