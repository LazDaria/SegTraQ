...
class _RSFacade:
    ...
    def chi2_center_border_similarity(
        ...
        return rs.chi2_center_border_similarity(
            sdata=self._p.sdata,
            tables_key=self._p.tables_key,
            tables_cell_id_key=self._p.tables_cell_id_key,
            shapes_key=self._p.shapes_key,
    ...
    def fisher_center_border_similarity(
        ...
        return rs.fisher_center_border_similarity(
            sdata=self._p.sdata,
            tables_key=self._p.tables_key,
            tables_cell_id_key=self._p.tables_cell_id_key,
            shapes_key=self._p.shapes_key,
    ...
    def mixture_fit_contamination_score(
        ...
        return  rs.mixture_fit_contamination_score(
            sdata=self._p.sdata,
            tables_key=self._p.tables_key,
            tables_cell_id_key=self._p.tables_cell_id_key,
            shapes_key=self._p.shapes_key,
    ...
    def mixture_fit_contamination_score_bootstrap(
        ...
        return rs.mixture_fit_contamination_score_bootstrap(
            sdata=self._p.sdata,
            tables_key=self._p.tables_key,
            tables_cell_id_key=self._p.tables_cell_id_key,
            shapes_key=self._p.shapes_key,
