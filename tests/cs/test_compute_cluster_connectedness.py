...
def test_compute_cluster_connectedness(sdata_new):
    cc = st.cs.compute_cluster_connectedness(sdata_new, resolution=1.0, key_prefix="leiden_subset", random_state=42)
