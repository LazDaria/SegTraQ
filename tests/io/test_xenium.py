...
#     st.io.create_geopandas_df(xenium_cell_boundaries)
#     st.io.create_geopandas_df(xenium_nucleus_boundaries)
...
# ):
#     # converting the data frames into geopandas dfs
#     cell_shapes = st.io.create_geopandas_df(xenium_cell_boundaries)
#     nucleus_shapes = st.io.create_geopandas_df(xenium_nucleus_boundaries)

#     sdata = st.io.create_spatialdata(
...
#     st.io.validate_spatialdata(sdata, cell_key_points="cell_id")
